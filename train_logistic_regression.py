...
OUTPUT_ROOT = Path("analysis_outputs") / "logistic_regression"
...
def build_search() -> GridSearchCV:
    ...
    param_grid = {
        "model__C": [0.05, 0.1, 0.2, 0.5, 1.0, 2.0],
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train a Logistic Regression probability estimator for blueWins."
    )
    parser.add_argument(
        "--feature-set",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output directory. Defaults to analysis_outputs/logistic_regression/<feature-set>.",
    )
...
def main() -> None:
    ...
    save_calibration_curve(
        ...
        f"Logistic Regression Calibration Curve ({args.feature_set})",
    )
